---
title: 'Dedilhado Violão: Os vários níveis e como aprimorar! - Amigo Violão'
description: >-
  Saiba em qual nível você está no dedilhado e qual a melhor maneira de
  praticá-lo, a fim de elevar o seu nível de dedilhado no violão!
date: '2021-09-01'
modified: '2021-09-07'
slug: dedilhado-violao-os-varios-niveis-e-como-aprimorar
categories:
...
Neste nível, o seu dedilhado já se tornou enriquecido por **movimentos mais simples na mão esquerda** (você tira ou coloca “dedos” no acorde, a fim de embelezar o som). A sua mão direita, por outro lado, já é mais **ágil e firme**, tendo uma certa liberdade de **variar** o dedilhado em certos momentos. (você pode estar mantendo _p i a m_, por exemplo, e, em certo momento da música, tocar _p a m i_). Aqui, você já é capaz de tocar quase tudo do repertório de pop e rock, sem muitas dificuldades.

**Nível 3:**

Aqui, você já é capaz de tocar **peças para violão solo** mais simples (de _Greensleeves_ até alguns de estudos do _Carcassi_). Os dedos de suas duas mãos **se coordenam** bem mutuamente, havendo tanto **variações** na esquerda quanto na direita. Os dedilhados mais simples já são bem fáceis para você.
