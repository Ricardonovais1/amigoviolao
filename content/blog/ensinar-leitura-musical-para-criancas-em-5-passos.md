---
title: Ensinar Leitura Musical para Crianças em 5 passos!
description: >-
  Leitura musical para crianças: Para que não dependa apenas do talento ou da
  vontade do aluno, é necessária uma didática correta. Começa antes da
  Partitura!
date: '2016-08-25'
modified: '2020-07-05'
slug: ensinar-leitura-musical-para-criancas-em-5-passos
categories:
...
tags:
  ...
  - como-ensinar-leitura
  - como-ensinar-partitura
  - curso-de-violao-para-criancas
  - educacao-musical-infantil
  - ensinar-musica-a-criancas
  - kodaly
  - leitura-absoluta
  - leitura-grafica
featured_image: /images/blog/ensinar-leitura-musical-para-criancas-em-5-passos.webp
og_image: /images/blog/ensinar-leitura-musical-para-criancas-em-5-passos.webp
canonical: 'https://amigoviolao.com/ensinar-leitura-musical-para-criancas-em-5-passos'
wpId: 1246
---

Na **educação musical** existem diversas formas de se ensinar a **leitura musical para crianças**. Afinal, o que diferencia a mera vivência musical do aprendizado da linguagem musical é que nesta, existe uma apropriação do som, que o torna mais tangível. Menos abstrato e mais concreto. Esse é o próprio papel da leitura e da escrita. E este é o papel das aulas de música de maneira geral. A Vivência do som adquirindo significados mais tangíveis, se tornando linguagem. Neste POST te mostro quais são os 5 passos que eu utilizo para ensinar a leitura musical a meus alunos, e que aprofundo no programa [Professor de Violão para Crianças](https://amigoviolao.com/criancas).
...
A leitura auditiva, no senso comum não seria considerado como leitura. Mas no contexto que estou apresentando é leitura. No sentido de que a imitação e uso de palavras para apreensão de ritmos, não passam pela leitura de um texto escrito, mas ainda assim configuram uma apreensão de símbolos que são transformados em outros símbolos.
...
## 2 – Leitura para Crianças – Leitura Gráfica:
...
A leitura gráfica será um prato cheio também para se trabalhar o canto. Eu gosto de usar melodias de 4 compassos, com uma letra e apenas 2 notas (uma presa e uma solta no violão). É exatamente o caso da música Nova Iorque que você vê acima.
...
## 4 – Leitura Musical para crianças – Leitura Relativa:
...
Você é professor(a) de violão? Uma das melhores formas que existem hoje, de você se capacitar rapidamente e de forma eficiente para dar aulas de violão para crianças é o [PROVIC (Professor de Violão para Crianças)](https://amigoviolao.com.br/provic-professor-de-violao-para-criancas). Este treinamento cobre repertório desde a escrita gráfica até a relativa. Considero que são as principais bases, e que diferenciam este método de outros mais tradicionais, para crianças. As escritas gráfica e espacial são responsáveis por uma vivência musical sem bloqueios através do violão.

## Conclusão:

Ensinar a leitura musical para crianças é mais do que uma tarefa, mas um meio por onde ensinar música. Os diferentes registros servem a este propósito.

Para muitos alunos eu nem mesmo chego a ensinar como ler uma partitura, porque não vejo um motivo real para isso. Devemos ter, acredito eu, uma postura crítica quanto ao que é ou não é necessário para a evolução de cada aluno.
