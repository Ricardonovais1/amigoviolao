---
title: 'Curso de Violão Iniciantes: Como Manter a MOTIVAÇÃO? - Amigo Violão'
description: >-
  O que fazer para manter a motivação no curso de violão para iniciantes? Como
  não tornar o aprendizado chato ou frustrante? Veja aqui!
date: '2021-08-04'
modified: '2021-09-19'
slug: curso-de-violao-iniciantes-como-manter-a-motivacao
categories:
  - o-professor-e-a-musica
tags:
  - aprender-a-tocar-violao-do-zero
  - aprender-violao-online
  - como-tocar-no-violao
  - como-tocar-violao
  - como-tocar-violao-iniciante
  - como-tocar-violao-pela-primeira-vez
...
Não é raro vermos pessoas que iniciam um projeto pessoal e **não o finalizam**. Em um curso de violão para iniciantes, isto é especialmente comum. É importante dizer, no entanto, que isso geralmente não ocorre por um motivo “besta”, por pura preguiça ou incompetência (seria até injusto alegar isto). Ocorre, sim, por uma única razão, que é, no entanto, capaz de **jogar fora** todas aquelas horas de esforço e comprometimento com o instrumento, capaz de **gerar uma frustração** que aterre de uma só vez o seu **sonho de tocar violão**. Esta razão é a **falta de uma boa orientação**.
...
Muitos, que nunca pegaram em um violão na vida, ficam abismados com a capacidade que os violonistas têm de posicionar seus dedos naquelas casinhas do instrumento e de acertar cada uma daquelas cordas com precisão. Parece algo até mesmo inalcançável para eles, e quando eles mesmos tentam fazer, o dedo trava, não respondendo às intenções. É frustrante…

### 2) Dificuldades rítmicas

Outros talvez não tenham tanta dificuldade motora (para formar os acordes e acertar as cordas), mas ficam frustrados com aquilo que chamamos de **tocar no tempo**. Por mais que tentem manter a atenção no que está acontecendo, sempre erram o momento de mudar de acorde, o ritmo das batidas etc…
...
É necessário que o aluno **se divirta** tocando violão, e não há nada mais divertido do que **tocar músicas**, não é mesmo?
Mas não é só “tocar músicas”, porque é necessário que a música a ser tocada **não frustre o aluno**, é necessário que ela corresponda ao nível em que ele está no instrumento! Assim, **por meio das próprias músicas**, ele desenvolve sua técnica motora, seu senso rítmico e sua leitura musical, tudo isto **ao mesmo tempo**.
...
Por isso (e para isso), o site Amigo Violão conta com o **MOVI**, que considera meticulosamente todos esses aspectos e degraus, a fim de que você **não tropece**, caia e se desmotive no seu estudo de violão.
O curso [**MOVI** (Método Otimizado de Violão Para Iniciantes)](https://amigoviolao.com/courses/violao-para-iniciantes-sortudos-inicio/) é dividido em **6 microníveis**, sendo cada um destes microníveis como um mini curso, compreendendo a **técnica** do violão, o desenvolvimento da **musicalidade** e o **ritmo**, tudo isso de forma natural!
Cada um dos microníveis contém um repertório de músicas adequadas ao estágio em que você se encontra, além de conteúdos de apoio (aulas de teoria, técnica etc.), que lhe auxiliam, **por meio das músicas**, a progredir no aprendizado do violão.

Quer saber mais? Então [**clique aqui!**](https://amigoviolao.com/nave-amigo-violao/)
