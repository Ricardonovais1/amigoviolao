...
import { matchingModule } from "./questions/MatchingQuestion";
...
// (ordering, fill-blank, free-text, essay, survey) simplesmente não
...
export const registry: Partial<Record<Question["type"], QuestionModule>> = {
  ...
  matching: matchingModule as QuestionModule,
};
