...
export const defaultFaqs: FaqItem[] = [
  ...
  {
    question:
      "Qual diferença deste método para outros métodos de violão para crianças?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Sim! Você pode assistir de três formas: abrindo a plataforma pelo navegador da sua smart TV, transmitindo do celular para a TV via Chromecast ou AirPlay pelo app da Hotmart, ou espelhando a tela do celular. Na tela grande fica muito mais fácil para a criança acompanhar as aulas enquanto segura o violão.",
  },
];
